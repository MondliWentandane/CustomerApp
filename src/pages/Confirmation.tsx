        ...
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <main className="grow">
                <div className="max-w-4xl mx-auto p-8 font-sans">
                    ...
                    <div className="flex justify-between items-start pb-8 border-b border-gray-300">
                        <div className="flex items-center">
                            <img src="/logo.png" alt="StayEase Logo" className="w-12 h-12 mr-2" />
                    ...
                    <h1 className="text-3xl font-bold mt-10 mb-8 text-gray-900">
                        Booking Confirmation
                    </h1>

                    {/* Booking & Guest Details Section */}
                    <div className="grid grid-cols-2 gap-x-12 gap-y-2 text-gray-700 text-base mb-10">
                        {/*Stay Details */}
                        <div>
                        ...
                        <table className="min-w-full table-auto">
                            <thead className="bg-[#DC9E38] text-black">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-center font-bold">Unit Price</th>
                                    <th className="px-4 py-3 text-right font-bold">Amount (R)</th>
                                </tr>
                            </thead>
                            <tbody className="bg-white divide-y divide-gray-200 text-gray-800">
                                ...
                                {/*  Room Stay Cost */}
                                <tr>
                                    <td className="px-4 py-3">**{BOOKING_DETAILS.Nights} days stay** ({BOOKING_DETAILS.RoomType})</td>
                                    <td className="px-4 py-3 text-center">{BOOKING_DETAILS.Rooms} Rooms x {BOOKING_DETAILS.Nights} Nights</td>
                                    <td className="px-4 py-3 text-center">R{ROOM_RATE_PER_NIGHT.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-right font-semibold">R{totalRoomCost.toLocaleString()}</td>
                                </tr>
                                
                                {/* Breakfast Cost */}
                                <tr>
                                    <td className="px-4 py-3">**{BOOKING_DETAILS.Nights} days Breakfast** (5 Guests)</td>
                                    <td className="px-4 py-3 text-center">{BOOKING_DETAILS.Guests} Guests x {BOOKING_DETAILS.Nights} Nights</td>
                                    <td className="px-4 py-3 text-center">R{BREAKFAST_PER_PERSON_PER_NIGHT.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-right font-semibold">R{totalBreakfastCost.toLocaleString()}</td>
                                </tr>
                                
                                {/* Room Cleaning Cost */}
                                <tr>
                                    <td className="px-4 py-3">Room cleaning</td>
                                    <td className="px-4 py-3 text-center">{BOOKING_DETAILS.Rooms} Rooms x {BOOKING_DETAILS.Nights} Nights</td>
                                    <td className="px-4 py-3 text-center">R{ROOM_CLEANING_PER_NIGHT.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-right font-semibold">R{totalCleaningCost.toLocaleString()}</td>
                                </tr>
                                ...
                                {/* Service Fee */}
                                 <tr>
                                    ...
                                    <td className="px-4 py-3 text-center">R{SERVICE_FEE.toLocaleString()} (Flat)</td>
                                    <td className="px-4 py-3 text-right font-semibold">R{SERVICE_FEE.toLocaleString()}</td>
                                </tr>
                                
                                {/* Total Row */}
                                <tr className="bg-gray-50 font-bold border-t-2 border-gray-900">
                                    <td colSpan={3} className="px-4 py-3 text-right">Total Paid</td>
                                    <td className="px-4 py-3 text-right text-lg text-green-700">R{finalTotal.toLocaleString()}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="flex flex-col space-y-4">
                        <button className="w-full bg-[#DC9E38] text-black py-3 rounded font-semibold hover:bg-[#c38c2f] transition shadow-md">
                            Download Receipt
                        </button>
                        <button className="w-full bg-[#DC9E38] text-black py-3 rounded font-semibold hover:bg-[#c38c2f] transition shadow-md">
                            Email Transcript
                        </button>
                        <button className="w-full border border-gray-400 text-gray-700 py-3 rounded font-semibold hover:bg-gray-50 transition flex items-center justify-center">
