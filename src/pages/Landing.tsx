  ...
  return (
    ...
    {/* Navbar */}
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/Modern Luxury Interior copy.png')",
        }}
      >
        ...
        <Link to="/signup">
          <button className="mt-8 bg-[#DC9E38] px-8 py-3 rounded-md text-lg font-semibold text-white font-poppins hover:bg-[#c38c2f] transition">
            Discover More
          </button>
          </Link>
        </div>
...
<div className="w-full flex flex-col md:flex-row mt-20">
  ...
  <div className="w-full md:w-1/2 bg-white p-10 flex flex-col justify-center">
    ...
    <p className="text-black mt-4 leading-relaxed text-[15px]">
      StayEase is the best luxury hotel in South Africa, offering an
      unmatched blend of elegance, comfort, and world-class
      hospitality. It brings 5-star services to guests in a convenient
      and beautifully simple way—designed to make every moment
      unforgettable. From breathtaking suites to exceptional amenities
      crafted for your relaxation, StayEase is where luxury meets ease.
      Discover more and experience the kind of stay you truly deserve.
    </p>
...
<div className="w-full flex items-center justify-center my-16">
  ...
  <img
    src="/logo 2.png"
    alt="Divider Logo"
    className="mx-6 h-16 w-auto object-contain"
  />
...
{/* FACILITIES SECTION */}
<div className="w-[1500px] h-[600px] bg-[#403D36] py-16 ml-50 mt-50">
...
<div className="flex justify-center relative z-30 px-4 mt-[-200px]">
  <div className="flex space-x-6">
    ...
    {/* IMAGE 1 */}
    <img
      src="/Tranquil Breakfast Scene.png"
